...
ros::Publisher cmd_vis_pub, pos_cmd_pub, traj_pub, time_left_pub;
...
void cmdCallback(const ros::TimerEvent& e) {
  ...
  // *************************custom code**************************
  std_msgs::Float32 time_left_msg;
  time_left_msg.data = traj_duration_ - t_cur; 
  time_left_pub.publish(time_left_msg);
  // *************************custom code**************************
...
int main(int argc, char** argv) {
  ...
  time_left_pub = node.advertise<std_msgs::Float32>("/time_left_of_current_traj", 10);
